...
python -u train.py \
  ...
  --evaluate=0 \
  --weight=/mnt/lustre/sunpeng/Research/video-seg-workshop/models/final_patch_seg_youtube_online_backup_test/exp/drivable/youtube_slr/model/train_epoch_7.pth \
  --weight_flow=/mnt/lustre/sunpeng/Research/video-seg-workshop/models/final_flow_patch_seg_youtube_online/exp/drivable/youtube_flow/model/train_epoch_5.pth \
  --ignore_label 255 \
  --workers 2 \
