...
python -u train.py \
  ...
  --evaluate=0 \
  --weight=/mnt/lustre/sunpeng/Research/video-seg-workshop/models/deeplabv3_models/final_patch_seg_youtube_online_fix_patch/exp/drivable/youtube_rgb_fix_patch/model/train_epoch_1.pth \
